...
var IllyriaServer = function(options, zookeeperOptions) {
    ...
    this.zookeeper = null;
    if(zookeeperOptions && Object.keys(zookeeperOptions)) {
    ...
    this.server = ISocket.createServer(options, this._onClientConnected.bind(this));
};
...
IllyriaServer.prototype.listen = function(port, host, callback) {
    ...
    this.server.listen(port, host, function() {
        if(!self.zookeeperOptions) return callback();
